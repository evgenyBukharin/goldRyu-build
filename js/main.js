(() => {
    var e = {
            ...
            472: () => {
                const e = document.querySelectorAll('.catalog-hero__container-visible .catalog-hero__container-image'),
                    t = document.querySelector('.catalog-hero__container-hidden'),
                    s = document.querySelector('.catalog-hero__container-visible');
                null !== e &&
                    null !== t &&
                    null !== s &&
                    e.forEach((e) => {
                        e.addEventListener('click', () => {
                            const i = e.getAttribute('data-category'),
                                ...
                                r = document.querySelector(`[data-category-filter="${i}"]`).closest('.catalog-hero__item');
                            console.log(r), a.classList.add('catalog-hero__container-category-first'), t.classList.remove('catalog-hero__container-hidden'), s.classList.add('catalog-hero__container-hidden'), (r.style.order = '2'), document.querySelector('.header').scrollIntoView({ behavior: 'smooth', block: 'start' });
                            let n = document.querySelectorAll('.catalog-hero__container-category');
                            n[n.length - 1] !== a ? (n[n.length - 1].style.marginBottom = '0') : (n[n.length - 2].style.marginBottom = '0');
                        });
                    });
            },
            27: () => {
            ...
            240: () => {
                ...
                if (null !== e && null !== t && null !== s) {
                    ...
                    window.addEventListener('scroll', () => {
                        a() > i && r() ? (s.classList.remove('nav-open'), (s.style.maxHeight = null)) : a() < i && !r() && (s.classList.add('nav-open'), (s.style.maxHeight = s.scrollHeight + 'px')), (i = a());
                    });
                }
            },
            848: () => {
            ...
            986: () => {
                    ...
                    (t.forEach((t) => {
                        t.addEventListener('click', () => {
                            e.classList.contains('search-visible')
                                ...
                                : (null !== i && null !== a && (a.classList.remove('menu__bg-active'), i.classList.remove('burger--active')),
                                  setTimeout(() => {
                ...
                null !== r && null !== n && (r.style.marginTop = n.offsetHeight + 'px');
            },
            290: () => {
    ...
    (() => {
            ...
            for (let a = 1; a < e.length; a += 1) {
                ...
                if (null != r && ((i = r), !('undefined' != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                    ...
                    for (let s = 0, i = e.length; s < i; s += 1) {
                        ...
                        void 0 !== a && a.enumerable && (c(t[i]) && c(r[i]) ? (r[i].__swiper__ ? (t[i] = r[i]) : p(t[i], r[i])) : !c(t[i]) && c(r[i]) ? ((t[i] = {}), r[i].__swiper__ ? (t[i] = r[i]) : p(t[i], r[i])) : (t[i] = r[i]));
                    }
                }
            }
            var i;
        ...
        const L = {
            ...
            M = (e) => {
                ...
                else for (let i = Math.max(r - t, 0); i <= Math.min(r + t, s - 1); i += 1) i !== a && i > r && _(e, i);
            },
            P = {
                updateSize: function () {
                    const e = this;
                ...
                updateSlides: function () {
                    ...
                    for (let a = 0; a < m; a += 1) {
                        let r;
                        if (((P = 0), p[a] && (r = p[a]), M && e.grid.updateSlide(a, r, m, t), !p[a] || 'none' !== v(r, 'display'))) {
                            if ('auto' === i.slidesPerView) {
                                k && (p[a].style[t('width')] = '');
                                const n = getComputedStyle(r),
                                    l = r.style.transform,
                                    o = r.style.webkitTransform;
                                if ((l && (r.style.transform = 'none'), o && (r.style.webkitTransform = 'none'), i.roundLengths)) P = e.isHorizontal() ? y(r, 'width', !0) : y(r, 'height', !0);
                                else {
                                    const e = s(n, 'width'),
                                        t = s(n, 'padding-left'),
                                        i = s(n, 'padding-right'),
                            ...
                            } else (P = (n - (i.slidesPerView - 1) * x) / i.slidesPerView), i.roundLengths && (P = Math.floor(P)), p[a] && (p[a].style[t('width')] = `${P}px`);
                            p[a] && (p[a].swiperSlideSize = P),
                                b.push(P),
                                i.centeredSlides
                                    ? ((L = L + P / 2 + C / 2 + x), 0 === C && 0 !== a && (L = L - n / 2 - x), 0 === a && (L = L - n / 2 - x), Math.abs(L) < 0.001 && (L = 0), i.roundLengths && (L = Math.floor(L)), _ % i.slidesPerGroup == 0 && h.push(L), g.push(L))
                                    : (i.roundLengths && (L = Math.floor(L)), (_ - Math.min(e.params.slidesPerGroupSkip, _)) % e.params.slidesPerGroup == 0 && h.push(L), g.push(L), (L = L + P + x)),
                                (e.virtualSize += P + x),
                                (C = P),
                                (_ += 1);
                        }
                    }
                    if (((e.virtualSize = Math.max(e.virtualSize, n) + S), l && o && ('slide' === i.effect || 'coverflow' === i.effect) && (a.style.width = `${e.virtualSize + i.spaceBetween}px`), i.setWrapperSize && (a.style[t('width')] = `${e.virtualSize + i.spaceBetween}px`), M && e.grid.updateWrapperSize(P, h, t), !i.centeredSlides)) {
                        const t = [];
                    ...
                    if ((Object.assign(e, { slides: p, snapGrid: h, slidesGrid: g, slidesSizesGrid: b }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
                        u(a, '--swiper-centered-offset-before', -h[0] + 'px'), u(a, '--swiper-centered-offset-after', e.size / 2 - b[b.length - 1] / 2 + 'px');
                        const t = -e.snapGrid[0],
                            s = -e.slidesGrid[0];
                        (e.snapGrid = e.snapGrid.map((e) => e + t)), (e.slidesGrid = e.slidesGrid.map((e) => e + s));
                    }
                    if ((m !== c && e.emit('slidesLengthChange'), h.length !== E && (e.params.watchOverflow && e.checkOverflow(), e.emit('snapGridLengthChange')), g.length !== T && e.emit('slidesGridLengthChange'), i.watchSlidesProgress && e.updateSlidesOffset(), !(d || i.cssMode || ('slide' !== i.effect && 'fade' !== i.effect)))) {
        ...
        function I(e) {
            ...
            Object.assign(a, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), (o.startX = v), (o.startY = b), (a.touchStartTime = d()), (t.allowClick = !0), t.updateSize(), (t.swipeDirection = void 0), n.threshold > 0 && (a.allowThresholdMove = !1);
            let S = !0;
            ...
            (!n.touchStartForcePreventDefault && !E) || u.isContentEditable || p.preventDefault(), t.params.freeMode && t.params.freeMode.enabled && t.freeMode && t.animating && !n.cssMode && t.freeMode.onTouchStart(), t.emit('touchStart', p);
        }
        function O(e) {
            const t = r(),
                s = this,
            ...
            if (!s.allowTouchMove) return c.target.matches(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(n, { startX: m, startY: h, prevX: s.touches.currentX, prevY: s.touches.currentY, currentX: m, currentY: h }), (i.touchStartTime = d())));
            ...
            if (void 0 === i.isScrolling) {
                let e;
                (s.isHorizontal() && n.currentY === n.startY) || (s.isVertical() && n.currentX === n.startX) ? (i.isScrolling = !1) : f * f + g * g >= 25 && ((e = (180 * Math.atan2(Math.abs(g), Math.abs(f))) / Math.PI), (i.isScrolling = s.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle));
            }
            ...
            a.oneWayMovement && ((v = Math.abs(v) * (l ? 1 : -1)), (b = Math.abs(b) * (l ? 1 : -1))), (n.diff = v), (v *= a.touchRatio), l && ((v = -v), (b = -b));
            ...
            if (
                ...
                v > 0
                    ? (y && !S && i.currentTranslate > (a.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({ direction: 'prev', setTranslate: !0, activeSlideIndex: 0 }), i.currentTranslate > s.minTranslate() && ((E = !1), a.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** T)))
                    : v < 0 &&
                      (y && !S && i.currentTranslate < (a.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({ direction: 'next', setTranslate: !0, activeSlideIndex: s.slides.length - ('auto' === a.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(a.slidesPerView, 10))) }),
                      i.currentTranslate < s.maxTranslate() && ((E = !1), a.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** T))),
        ...
        function j(e, t) {
            return function (s = {}) {
                const i = Object.keys(s)[0],
                    a = s[i];
                'object' == typeof a && null !== a ? (['navigation', 'pagination', 'scrollbar'].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }), i in e && 'enabled' in a ? (!0 === e[i] && (e[i] = { enabled: !0 }), 'object' != typeof e[i] || 'enabled' in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), p(t, s)) : p(t, s)) : p(t, s);
            };
        }
        const R = {
                eventsEmitter: L,
                ...
                translate: {
                    ...
                    setTranslate: function (e, t) {
                        ...
                        s.isHorizontal() ? (o = i ? -e : e) : (d = e),
                            ...
                            a.cssMode ? (r[s.isHorizontal() ? 'scrollLeft' : 'scrollTop'] = s.isHorizontal() ? -o : -d) : a.virtualTranslate || (s.isHorizontal() ? (o -= s.cssOverflowAdjustment()) : (d -= s.cssOverflowAdjustment()), (r.style.transform = `translate3d(${o}px, ${d}px, 0px)`));
                ...
                transition: {
                    ...
                    transitionStart: function (e = !0, t) {
                        const s = this,
                            { params: i } = s;
                        i.cssMode || (i.autoHeight && s.updateAutoHeight(), k({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
                    },
                    transitionEnd: function (e = !0, t) {
                        const s = this,
                            { params: i } = s;
                        (s.animating = !1), i.cssMode || (s.setTransition(0), k({ swiper: s, runCallbacks: e, direction: t, step: 'End' }));
                    },
                },
                slide: A,
                loop: {
                ...
                events: {
                    attachEvents: function () {
                        const e = this,
                            t = r(),
                            { params: s } = e;
                        (e.onTouchStart = I.bind(e)), (e.onTouchMove = O.bind(e)), (e.onTouchEnd = z.bind(e)), s.cssMode && (e.onScroll = $.bind(e)), (e.onClick = B.bind(e)), (e.onLoad = G.bind(e)), D || (t.addEventListener('touchstart', F), (D = !0)), H(e, 'on');
                    },
        ...
        class Y {
            constructor(...e) {
                        ...
                        return (
                            E ||
                                (E = (function ({ userAgent: e } = {}) {
                                    ...
                                    let h = 'MacIntel' === i;
                                    return (
                                        !c && h && t.touch && ['1024x1366', '1366x1024', '834x1194', '1194x834', '834x1112', '1112x834', '768x1024', '1024x768', '820x1180', '1180x820', '810x1080', '1080x810'].indexOf(`${n}x${o}`) >= 0 && ((c = a.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, '13_0_0']), (h = !1)),
                ...
                const n = {};
                a.modules.forEach((e) => {
                    e({ params: s, swiper: a, extendParams: j(s, n), on: a.on.bind(a), once: a.once.bind(a), off: a.off.bind(a), emit: a.emit.bind(a) });
                });
                const o = p({}, V, n);
                return (
                    (a.params = p({}, o, W, s)),
            ...
            mount(e) {
                ...
                return (
                    ...
                    Object.assign(t, { el: s, wrapperEl: a, slidesEl: t.isElement ? s : a, mounted: !0, rtl: 'rtl' === s.dir.toLowerCase() || 'rtl' === v(s, 'direction'), rtlTranslate: 'horizontal' === t.params.direction && ('rtl' === s.dir.toLowerCase() || 'rtl' === v(s, 'direction')), wrongRTL: '-webkit-box' === v(a, 'display') }),
                    !0
                );
            }
            init(e) {
                    ...
                    t('init', () => {
                        e.params.resizeObserver && void 0 !== i.ResizeObserver
                            ? e &&
                              ...
                              a.observe(e.el))
                            : (i.addEventListener('resize', n), i.addEventListener('orientationchange', o));
                    }),
                        t('destroy', () => {
                            r && i.cancelAnimationFrame(r), a && a.unobserve && e.el && (a.unobserve(e.el), (a = null)), i.removeEventListener('resize', n), i.removeEventListener('orientationchange', o);
                        });
                },
        ...
        X.use([
            function ({ swiper: e, extendParams: t, on: s, emit: i }) {
                ...
                function c(t) {
                    ...
                    if (e.params.loop) {
                        ...
                        t > e.slides.length - e.loopedSlides && e.loopFix({ direction: t > s ? 'next' : 'prev', activeSlideIndex: t, slideTo: !1 }), e.slideToLoop(i);
                    } else e.slideTo(i);
                }
                function p() {
                    const t = e.rtl,
                    ...
                    if ((e.params.loop ? ((c = e.previousRealIndex || 0), (a = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex)) : void 0 !== e.snapIndex ? ((a = e.snapIndex), (c = e.previousSnapIndex)) : ((c = e.previousIndex || 0), (a = e.activeIndex || 0)), 'bullets' === s.type && e.pagination.bullets && e.pagination.bullets.length > 0)) {
                        ...
                        if (
                            (s.dynamicBullets &&
                                ...
                                s.dynamicMainBullets > 1 && void 0 !== c && ((n += a - (c || 0)), n > s.dynamicMainBullets - 1 ? (n = s.dynamicMainBullets - 1) : n < 0 && (n = 0)),
                                (l = Math.max(a - n, 0)),
                ...
                function u() {
                    ...
                    'fraction' === t.type && (r = t.renderFraction ? t.renderFraction.call(e, t.currentClass, t.totalClass) : `<span class="${t.currentClass}"></span> / <span class="${t.totalClass}"></span>`),
                        ...
                        a.forEach((s) => {
                            'custom' !== t.type && (s.innerHTML = r || ''), 'bullets' === t.type && e.pagination.bullets.push(...s.querySelectorAll(K(t.bulletClass)));
                        }),
                ...
                function m() {
                    ...
                    'string' == typeof t.el && e.isElement && (s = e.el.shadowRoot.querySelector(t.el)),
                        ...
                        s &&
                            0 !== s.length &&
                            (e.params.uniqueNavElements && 'string' == typeof t.el && Array.isArray(s) && s.length > 1 && ((s = [...e.el.querySelectorAll(t.el)]), s.length > 1 && (s = s.filter((t) => w(t, '.swiper')[0] === e.el)[0])),
            ...
            function ({ swiper: e, extendParams: t, on: s }) {
                ...
                function o(t) {
                    ...
                    if ((e.params.slidesPerView > 1 && !e.params.centeredSlides && (a = e.params.slidesPerView), e.params.thumbs.multipleActiveThumbs || (a = 1), (a = Math.floor(a)), s.slides.forEach((e) => e.classList.remove(r)), s.params.loop || (s.params.virtual && s.params.virtual.enabled)))
                        for (let t = 0; t < a; t += 1)
                            f(s.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach((e) => {
                                e.classList.add(r);
                            });
            ...
            function ({ swiper: e }) {
                Object.assign(e, { appendSlide: Z.bind(e), prependSlide: J.bind(e), addSlide: Q.bind(e), removeSlide: ee.bind(e), removeAllSlides: te.bind(e) });
            },
            function ({ swiper: e, extendParams: t, on: s, emit: i, params: a }) {
                let n, l;
                ...
                s('init', () => {
                    e.params.autoplay.enabled && (e.params.autoplay.pauseOnMouseEnter && (e.el.addEventListener('pointerenter', C), e.el.addEventListener('pointerleave', _)), r().addEventListener('visibilitychange', L), (v = new Date().getTime()), S());
                }),
                    s('destroy', () => {
                        e.el.removeEventListener('pointerenter', C), e.el.removeEventListener('pointerleave', _), r().removeEventListener('visibilitychange', L), e.autoplay.running && E();
                    }),
            ...
            new X(document.querySelector('.main-hero__slider'), { slidesPerView: 'auto', spaceBetween: 40, resistanceRatio: 0, speed: 400, grabCursor: !0, pagination: { el: '.main-hero__pagination', type: 'progressbar' }, breakpoints: { 481: { enabled: !0 }, 0: { enabled: !1 } }, loop: !0, autoplay: { delay: 5e3, pauseOnMouseEnter: !0 } }),
        ...
        const ae = new X('.catalog-item-hero__slider-thumbs .swiper-container', { slidesPerView: 3, direction: 'vertical', navigation: { nextEl: '.catalog-item-hero__button-next', prevEl: '.catalog-item-hero__button-prev' }, freeMode: !0, breakpoints: { 1025: { spaceBetween: 40 }, 481: { spaceBetween: 10, direction: 'vertical' }, 0: { direction: 'horizontal' } } }),
            re = (new X('.catalog-item-hero__slider-images .swiper-container', { slidesPerView: 1, spaceBetween: 30, mousewheel: !0, navigation: { nextEl: '.catalog-item-hero__button-next', prevEl: '.catalog-item-hero__button-prev' }, grabCursor: !0, thumbs: { swiper: ae } }), new X('.quiz__slider', { slidesPerView: 1, speed: 500, allowSlideNext: !1, allowSlidePrev: !1 })),
            ne = document.getElementById('startTestBtn');
        null !== ne &&
            ne.addEventListener('click', () => {
                (re.allowSlideNext = !0), re.slideNext(), (re.allowSlideNext = !1);
            });
        const le = new X('.quiz__slider-inner', { slidesPerView: 1, spaceBetween: 15, speed: 500, navigation: { nextEl: '.quiz__button-next', prevEl: '.quiz__button-prev' }, pagination: { el: '.quiz__pagination', type: 'progressbar' } }),
        ...
        const ce = new X('.main-design__slider', { slidesPerView: 1, speed: 500, allowSlideNext: !1, allowSlidePrev: !1 }),
        ...
        null !== me &&
            me.forEach((e) => {
                e.addEventListener('click', () => {
                    (ce.allowSlidePrev = !0), ce.slidePrev(), (ce.allowSlidePrev = !1), (pe.style.display = 'block');
                });
            }),
            s(27);
        class he {
            constructor(e, t, s) {
                (this.selector = e), (this.innerElements = t), (this.starterId = s), (this.tabs = document.querySelector(`[data-tabs="${e}"]`)), this.tabs && ((this.tabList = this.tabs.querySelector('.' + t.list)), (this.tabsBtns = this.tabList.querySelectorAll('.' + t.button)), (this.tabsPanels = this.tabs.querySelectorAll('.' + t.panel)), this.init(), this.events());
            }
            init() {
        ...
        new he('tab', { list: 'catalog-item-tabs__list', button: 'catalog-item-tabs__btn', panel: 'catalog-item-tabs__panel' }, 2), new he('quizTab', { list: 'quiz__list-tabs', button: 'quiz__btn', panel: 'quiz__panel' }, 0), s(661), s(617), s(578), s(774), s(472), s(586), s(986);
        const fe = () => {
        ...
        if (null !== ge) {
            ...
            null !== t && null !== s && (t.style.marginTop = s.offsetHeight + 'px'),
